...
const experienceData = [
  {
    ...
    description:
      "System discovery and application design based on the functional requirements. Working on MuleSoft development as a senior developer and API design using RAML.",
    achievements: [
      "Lead the integration teams",
      "Implemented API frameworks",
      "worked on MuleSoft AI Code Gen Agent",
    ],
  ...
  },
  {
    ...
    description:
      "System discovery and application design based on the functional requirements. Working closely with the client and the MuleSoft Delivery managers.",
  ...
  },
  {
    ...
    description:
      "Product design and development using MuleSoft and Java. Leading teams, managing projects, and handling stakeholder relationships. Responsible for project and resource management.",
    achievements: [
      "Managed a team of 10 engineers",
      "Increased project completion rate by 20%",
    ],
  ...
  },
  {
    ...
    description:
      "Worked on MuleSoft development as a senior developer. System discovery and application design based on the functional requirements. ",
  ...
  },
  {
    ...
    description:
      "Worked on MuleSoft development as a senior developer. API design using RAML and project leading.",
  ...
  },
  {
    ...
    achievements: [
      "Developed integration frameworks",
      "Designed Internal products to support Integration projects using Java",
    ],
  ...
  },
  {
    ...
    description:
      "Worked as Java developer trainee, focusing on core Java development and web applications.",
    achievements: [
      "Implemented Java web applications",
      "Participated in development of enterprise solutions",
    ],
...
const projectsData = [
  {
    ...
    company: "PWC",
    description:
      "Led the migration of financial data from Salesforce CRM to OIC, handling accounts, contacts, invoices, projects, and attachments. Implemented using Salesforce APEX Triggers, AWS Lambdas, and Kafka Services.",
    achievements: [
  ...
  },
  {
    ...
    company: "PWC",
    description:
      "Architected and implemented integration between Salesforce and SM API, using Apache Kafka and Oracle DB Systems with MuleSoft APIs hosted on RTF.",
    achievements: [
  ...
  },
  {
    ...
    company: "PWC",
    description:
      "Led the migration of Java Services to Mule4, connecting to Postgres and Webservices. Services expose policy-related data to consuming applications in JSON/XML format, deployed on Cloudhub.",
    achievements: [
  ...
  },
  {
    ...
    description:
      "Managed migration of Mule 3 APIs to Mule4, integrating with SFDC, Oracle, and AMQ. Services expose customer data, services, policy, and payment details for Hertz UI applications.",
    achievements: [
  ...
  },
  {
    ...
    description:
      "Developed a product providing Global API endpoints for retrieving customer information from multiple source systems.",
    achievements: [
  ...
  },
  {
    ...
    company: "Deloitte India Pvt Ltd",
    description:
      "Developed integration solutions for NYU's Student Health Center, providing universal healthcare services to students with hassle-free appointment scheduling and walk-in services.",
    achievements: [
  ...
  },
  {
    ...
    company: "Whishworks Pvt Ltd",
    description:
      "Led the ESB and Backend Tech team for a video-on-demand service, building integration middleware between client applications and business systems using Mule ESB.",
    achievements: [
  ...
  },
  {
    ...
    company: "Whishworks Pvt Ltd",
    description:
      "Developed interfaces and batch jobs for a new onshore digital banking environment, focusing on mobile and online customer experience.",
    achievements: [
  ...
  },
  {
    ...
    company: "IBM",
    description:
      "Developed Service Network (SNET) enabling applications to be loosely coupled, integrating various channels with legacy systems. Supporting over 97 services for consumers across ARGO, Mobile Banking, IVR, and e-Banking.",
    achievements: [
  ...
  },
  {
    ...
    description:
      "Developed ESS-ESO Communication system for handling Flight Events from ESO and generating FSS based on FSS Objects.",
    achievements: [
  ...
  },
  {
    ...
    description:
      "Developed an automation system for workflow execution, facilitating communication between client representatives and US doctors for appointment scheduling across various states.",
    achievements: [
